...
[AddComponentMenu("UI/Custom/Circle RawImage")]
[RequireComponent(typeof(RawImage))]
public class CircleRawImage : BaseMeshEffect, ICanvasRaycastFilter
{
    ...
    public override void ModifyMesh(VertexHelper vh)
    {
        ...
        if (fill) //圆形
        {
            ...
            for (int i = 1; i < verticeCount; i++)
            {
                ...
                curVertice = new Vector2(cosA * outerRadius, sinA * outerRadius) + center;
        ...
        else//圆环
        {
            ...
            for (int i = 0; i < verticeCount; i += 2)
            {
                ...
                curVertice = new Vector2(cosA * innerRadius, sinA * innerRadius) + center;
                uiVertex = new UIVertex();
                uiVertex.color = image.color;
                uiVertex.position = curVertice;
                uiVertex.uv0 = new Vector2(curVertice.x * uvScaleX + uvCenterX, curVertice.y * uvScaleY + uvCenterY);
