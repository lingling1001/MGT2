...
namespace com.ootii.Messages
{
    ...
    public class MessageDispatcher
    {
        ...
        public static void SendMessage(object rSender, string rType, object rData)
        {
            SendMessage(rSender, rType, rData, EnumMessageDelay.IMMEDIATE);
        }
        /// <summary>
        /// Create and send a message object
        /// </summary>
        ...
        {
            // Create the message
            SendMessage(null, "", rType, rData, EnumMessageDelay.IMMEDIATE);
        }
        /// <summary>
        /// Create and send a message object
        /// </summary>
        ...
        public static void Update()
        {
            ...
            for (int i = 0; i < mMessages.Count; i++)
            {
                ...
                if (lMessage.Delay < 0) { lMessage.Delay = EnumMessageDelay.IMMEDIATE; }
