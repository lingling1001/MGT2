...
public class ConfigLoadExtension
{
    ...
    {
        string path = ConfigLoadSetting.GetSavePath(EnumLoadSettingPath.XmlExternal);
        string pathInternal = ConfigLoadSetting.GetSavePath(EnumLoadSettingPath.XmlInternal);
