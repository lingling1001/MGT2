...
public partial class EntityHelper
{
    ...
    //            continue;
    //        }
    //        if (item.AssyCamp.Value == target.AssyCamp.Value)//阵营相同
    //        {
    //            continue;
    //        }
    //        list.Add(item);
    ...
    //{
    //    _listTemp.Clear();
    //    Dictionary<int, AssemblyEntity> map = GameManager.QGetOrAddMgr<EntityManager>().GetAllDatas();
    //    foreach (var item in map)
    //    {
