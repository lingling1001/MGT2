...
public sealed class GoapAgent : IUpdate
{
    ...
    {
        stateMachine.Update(goapAgentData);
    }

    public void OnInit(object goapData, IGoap goap, GoapAction[] actions)
    {
        Log.Debug(goapData.ToString() + " --> All actions: " + prettyPrint(actions));
    ...
    //{
    //    GoapAction[] actions = dataGoapAgent.GetActions();
    //    foreach (GoapAction a in actions)
    //    {
    //        availableActions.Add(a);
    //    }
